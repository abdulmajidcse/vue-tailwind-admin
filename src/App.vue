    ...
    >
      ...
      <nav class="flex justify-between mx-1">
        ...
        <a href="./index.html" class="flex items-center">
          ...
          <font-awesome-icon
            :icon="faLayerGroup"
            class="text-2xl mr-2 text-blue-800"
            title="Logo"
          />
          <span
            class="self-center text-lg font-semibold whitespace-nowrap dark:text-white hidden sm:inline-block"
            >Tailwind Admin</span
          >
        </a>

        <!-- menu wrapper for mobile menu -->
        <div class="flex justify-between lg:w-[calc(100%-15rem)]">
          <ul class="flex">
            <li>
              <button
                title="Sidebar Menu"
                ...
                data-tooltip-target="sidebar-menu-tooltip"
            ...
            <li>
              <a
                href="#"
                data-tooltip-target="visit-site-tooltip"
                class="inline-flex items-center p-2 text-base text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
              >
            ...
            <li>
              <template v-if="darkThemeIs">
                ...
                >
                  ...
                  <font-awesome-icon :icon="faSun" class="text-gray-500 dark:text-gray-400" />
                </button>
                <div
                  id="light-theme-tooltip"
                  role="tooltip"
                  class="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 tooltip dark:bg-gray-700"
                >
              ...
              <template v-else>
                ...
                >
                  ...
                  <font-awesome-icon :icon="faMoon" class="text-gray-500 dark:text-gray-400" />
                </button>
                <div
            ...
            <li class="lg:hidden">
              <button
                type="button"
                class="inline-flex items-center p-2 text-base text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
                @click="mobileMenuOpenIs = !mobileMenuOpenIs"
              >
          ...
          <div
            ...
            :class="{ hidden: !mobileMenuOpenIs }"
            @click="mobileMenuOpenIs = false"
          ></div>
          ...
          >
            <li>
              <button
                ...
                type="button"
              >
                <font-awesome-icon :icon="faBell" class="text-base" />
                ...
                Notifications
                <font-awesome-icon :icon="faChevronDown" class="text-xs ml-1" />
              </button>
              <!-- Dropdown menu -->
              <div
                id="dropdownNotification"
                class="hidden z-20 w-full max-w-sm bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-800 dark:divide-gray-700 max-h-[calc(100vh-100%)] overflow-y-auto awesome-scrollbar scroll-smooth"
            ...
            <li>
              ...
              >
                ...
                <!-- <img
                    ...
                    alt="user photo"
                  /> -->
                <font-awesome-icon :icon="faUserCircle" class="text-base mr-2" />
                Bonnie Green
                <font-awesome-icon :icon="faChevronDown" class="text-xs ml-1" />
              </button>
              ...
              >
                ...
                >
                  <li>
                    <a
                      ...
                      ><font-awesome-icon :icon="faUser" /><span class="ml-2">Profile</span></a
                    >
                  </li>
                  <li>
                    <a
                      href="#"
                      class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                      ><font-awesome-icon :icon="faLock" /><span class="ml-2"
                ...
                <div class="py-1">
                  <a
                    ...
                    ><font-awesome-icon :icon="faSignOut" /><span class="ml-2">Log Out</span></a
                  >
                </div>
              </div>
            </li>
      ...
      <div class="relative h-full min-w-full sm:min-w-[90vw] md:min-w-[70vw] lg:min-w-[50vw]">
        <div class="relative bg-white rounded shadow dark:bg-gray-700">
          <button
            ...
            data-modal-toggle="search-modal"
          >
            <font-awesome-icon :icon="faClose" class="text-lg" />
          ...
          <div class="relative bg-dark-700 pt-8 px-8 pb-16">
            ...
            >
              <font-awesome-icon :icon="faSearch" class="absolute bottom-2 left-1 text-gray-500" />
              <input
                type="text"
        ...
        <main class="pt-5 min-h-[calc(100vh-13rem)]">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                  ...
                  <li aria-current="page">
                    <div class="flex items-center">
                      <font-awesome-icon :icon="faAngleRight" class="text-slate-400" />
                      <span
          ...
          <section class="bg-white dark:bg-white/5 rounded shadow-lg p-3 mb-5">
            ...
            <input
              ...
              name="name"
              placeholder="Search here..."
              class="w-full mb-6 dark:bg-gray-900"
            />
        ...
        <footer class="bg-white dark:bg-gray-900/30 shadow-lg mt-5">
          <div class="px-3 pt-2 pb-8">
            ...
            <div class="flex flex-col items-center sm:flex-row sm:justify-between">
              <p class="text-sm text-gray-400">&copy; Copyright 2022. All Rights Reserved.</p>
